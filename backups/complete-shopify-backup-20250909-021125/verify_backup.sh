...
# Check Shopify Block Width Control
if grep -q "shopify-block:has" "$BACKUP_DIR/blocks/email-signup.liquid" 2>/dev/null; then
    echo "✅ Email Signup Block - Shopify block width control found"
else
    echo "❌ Email Signup Block - Shopify block width control missing"
fi
...
echo ""
echo "📋 Summary:"
echo "   Backup Date: September 9, 2025 - 02:11:25"
